 ...
 *  
 *  Purpose:
 *     To demonstrate concepts of Operator Oveloading and Templates in C++.    
 *  Fall, 2011
 *
 *  Problem:  To templatize the Safe Array (SA) class given in file 'safe array.pdf', 
 ...
 *      
 *  Input Format: 
 *        No input reqd., just check the main function, and run the program  
 *  OutPut Format:     
 *
  ...
  // initialization
   ...
   //SA x(10,20); x[15]= 100;
      int& operator[](int i){
       ...
       cout<<"Check why this is So: "<<p[i-low]<<"   Address:   "<<&p[i-low]<<endl;
